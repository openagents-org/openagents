...
class TestLLMLogsAPI(AioHTTPTestCase):
    ...
    async def get_application(self):
        ...
        # Create HTTP transport with workspace manager
        self.http_transport = HttpTransport()
        self.http_transport.workspace_manager = self.workspace_manager
...
class TestLLMLogsAPINoWorkspace:
    ...
    def http_transport(self):
        """Create HTTP transport without workspace manager."""
        transport = HttpTransport()
        transport.workspace_manager = None
        return transport
