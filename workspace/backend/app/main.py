...
from app.routers import account, app_version, browser, cloud_agents, devices, events, fetch, files, integration_bindings, integrations, knowledge, network, nodes, notifications, routines, search, shares, tasks, timers, todos, workflows, workspaces
...
app.include_router(integration_bindings.router)
