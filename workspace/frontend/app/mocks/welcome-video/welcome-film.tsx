...
// ═══════════════════════════════════════════════════════════════
// Onboarding welcome film (~30s) — derived from the Workspace 1.0
...
// Welcome cut: 5 scenes in 30s. SCENE_SCALE maps each slot back onto the
// original scene's timeline (localMs × scale), so e.g. the 26s Demo plays
// its whole story in 13s at 2× rather than stopping halfway.
const SCENE_TABLE: [number, number][] = [
  [0, 2_500], [2_500, 8_000], [8_000, 21_000], [21_000, 26_000], [26_000, 30_000],
];
const SCENE_SCALE = [1.2, 1.18, 2.0, 2.0, 1.25];
...
const SCENE_BOUNDARIES = [
  ...
  { id: 4, startMs: 21_000, label: 'Team' },
  { id: 5, startMs: 26_000, label: 'CTA' },
];
