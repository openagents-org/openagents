...
export const messages = {
  ...
  onboarding: {
    ...
    nodeStepBody: 'Install the OpenAgents desktop app on your device and enter the code below — we’ll detect it automatically.',
    ...
    optionADescription: 'Download the OpenAgents desktop app for a visual setup experience.',
    optionB: 'Option B',
  ...
  yumiDmIntro: {
    ...
    step1: 'Download the OpenAgents desktop app, or install the CLI on your device.',
    step2: 'Enter the pairing code when the desktop app asks for it during setup.',
  ...
  routines: {
    ...
    editDescription: 'Change what this recurring task does, when it runs, or which agent owns it.',
  ...
  admin: {
    ...
    devicesDescription:
      'Computers running the OpenAgents desktop app that are connected to this workspace.',
    generatePairingCode: 'Generate pairing code',
    pairingCodeHint: 'Enter this code in the desktop app within {minutes} minutes to connect a new device.',
  ...
  dashboard: {
    ...
    subtitle: 'Jump back into a workspace, or start something new.',
    networkError:
      "Can't reach the OpenAgents server right now. Check your network (VPN / proxy / firewall) and press Retry.",
    nameTitle: 'Name your workspace',
    namePlaceholder: 'e.g. Marketing team, Acme Corp…',
    createWorkspace: 'Create workspace',
    noActivity: 'No activity yet',
    startHere: '✨ Start here',
    backToHome: 'Back to OpenAgents home',
  },

  /** Sign-in gate on the home page, the login callback and the desktop sign-in landing. */
  auth: {
    signInTitle: 'Sign in to OpenAgents',
    signInBody: 'Sign in to see your workspaces.',
    signingIn: 'Signing you in…',
    signedIn: 'You are signed in',
    signInFailed: 'Sign-in failed',
    signInFailedRetry: 'Sign-in failed. Please try again.',
    backToSignIn: 'Back to sign in',
    missingToken: 'Missing sign-in token. Please try signing in again.',
    desktopLinkInvalid: 'This link is missing the information the desktop app needs.',
    desktopNoSession: 'Signed in, but no desktop session was issued. Please try again.',
    desktopUnreachable: 'Could not reach the desktop app.',
    desktopReturn: 'Return to OpenAgents to continue.',
  },
  ...
  connect: {
    ...
    agentDisplayNameHint: 'Shown in the workspace and in chats, in any language. Leave it empty to show the agent name.',
    agentNameFixedHint: 'The agent name is its identity — it is what an @mention uses — so it can’t change after creation.',
    nodeNativeCredRequired: 'Enter {field} — this agent can’t run without it.',
    nodeNativeCredsHint: 'These are stored only on the device that runs the agent. When editing, leave a field empty to keep the value already there.',
    ...
    nodeSubtitle: 'Devices running the OpenAgents desktop app, paired to this workspace.',
    ...
    nodeInstallDesktopHint: 'Install the desktop app, then enter the code above.',
    nodeInstallCli: 'Use the command line (servers & headless)',
    nodeStep1Title: 'Get the desktop app on your device',
    nodeMobileStep1Title: 'Get the desktop app on your computer',
    nodeMobileGoTo1: 'On your laptop, open',
    nodeMobileGoTo2: 'and download the desktop app.',
    ...
    nodeStep2Hint: 'The desktop app asks for this code during setup — click to copy.',
    nodeStep3Title: 'Wait for the device to connect',
    nodeStepOr: 'or',
    nodePairingInstall: 'Install the desktop app:',
    ...
    nodeAgentStalledHint: 'The device has not reported this agent. Check the desktop app on the device, or remove the agent and add it again.',
    ...
    nodeRemoveBody: 'This unpairs the device and forgets its agents in the workspace. The desktop app on the device won’t reconnect on its own — re-pair it with a new code if you need it back.',
    nodeRemoved: 'Node removed.',
    nodeRemoveFailed: 'Could not remove the node.',
    nodeRemoveForbidden: 'Only an owner or admin can remove a node.',
    nodeToggleDetails: 'Toggle details',

    // Cloud agents tab
    cloudAgentAddButton: 'Add Agent',
  ...
  agents: {
    ...
    removeAgentBody: 'This removes the agent from the workspace. If it is still running in the desktop app on that node, stop or remove it there too — otherwise it may rejoin.',
  ...
  campaign: {
    connectFirstAgent: 'Connect your first local agent with the desktop app or CLI to unlock +$20 in free API credits.',
    connectSecondAgent: 'Connect a different agent type via the desktop app or CLI to unlock +$10 more in API credits.',
    ...
    verifyFailed: 'Couldn’t resend from here. Sign in at openagents.org and use the link in your welcome email.',
    ...
    msFirstAgent: 'Connect your first agent (desktop app or CLI)',
    msFirstConversation: 'Have your first conversation',
    msSecondAgent: 'Connect a second agent type (desktop app or CLI)',
    msSecondAgentResponse: 'Get a reply from the second agent',
    toastUnlocked: '🎉 +${amount} API credits unlocked',
    toastProgress: '{label} — ${total} of ${cap} unlocked',
    toastDaily: 'Daily active bonus (day {day})',

    // Credits card on the workspace list (home page)
    homeTitle: '🎁 Free model credits',
    homeBody:
    ...
    homeBaseUrl: 'OpenAI-compatible · base URL {url}',
    homeRevealKey: 'Reveal',
    homeHideKey: 'Hide',
    homeCopyKey: 'Copy API key',
    homeKeyHint:
      'Works out of the box with OpenCode, Hermes, PI Agent — or any OpenAI-compatible client. No card required.',
  },

  // First-run welcome film on the connect page (components/connect/welcome-film.tsx).
  // Agent ids, product names, people's names, code and timestamps stay inline.
  welcomeFilm: {
    controls: {
      skip: 'Skip intro',
      getStarted: 'Get started',
    ...
    slides: {
      hubTitle: 'One Hub',
      collabTitle: 'Multi-Agent Collaboration',
      teamTitle: 'Humans + Agents',
    },
    // Mock product chrome shared by several scenes
    app: {
      you: 'You',
      leader: 'leader',
      human: 'human',
      ...
      connectAgent: 'Connect agent',
      threads: 'Threads',
      composerPlaceholder: 'Message… (@ to mention an agent)',
      timeNow: 'now',
      minutesShort: '{count}m',
      hoursShort: '{count}h',
      online: '{online}/{total} online',
      replyPlaceholder: 'Reply to your agents…',
      sharedBrowser: 'Shared browser',
    },
    hook: {
      kicker: 'You already run great agents',
      line1: 'But they never',
      line2: 'work together.',
    },
    title: {
      workspace: 'Workspace',
      tagline: 'The Collaboration OS for AI Agents',
    },
    hub: {
      rpgPreview: 'You: Build a mini RPG game…',
      auditTitle: 'Q3 revenue audit',
      auditPreview: '{agent}: Report is in /files',
      landingTitle: 'Landing page copy',
      landingPreview: '{agent}: Draft two is ready…',
      phoneRpgPreview: '{agent}: On it —',
      phoneAuditPreview: 'Report is in /files',
      phoneLandingPreview: 'Draft two is ready',
      msgStatus: 'Morning, team — status?',
      msgReady: 'All five agents online. Ready when you are.',
      kicker: '01 · One hub',
      line: 'Every agent in one workspace. Desktop and mobile.',
    },
    card: {
      kicker: '02 · They collaborate',
      line1: 'Three agents.',
      line2a: 'One job:',
      line2b: 'build a game.',
      sub: 'Watch a real thread — no cuts, no human glue.',
    },
    demo: {
      msgBrief: 'Build a mini RPG. {lead} leads, {art} on art, {qa} tests.',
      msgPlan: 'On it — a forest, a river with a bridge, and a dragon’s keep. Boss fight, loot, HUD.',
      stepWorld: 'game/world.ts — 16×8 tile map',
      msgSprites: 'Sprite sheet ready — hero, dragon, tileset, loot.',
      msgLive: '“Dragon’s Keep” v1 is live in the shared browser.',
      msgTesting: 'Testing now.',
      toolPlaytest: 'Playtest',
      stepPlaytest1: 'follow the path — fight the slime…',
      msgBug: 'Found a bug — the hero can’t cross the bridge. {lead} collision check?',
      msgPatched: 'Good catch — patched.',
      stepCollision: 'game/collision.ts — bridge tiles walkable',
      msgRetesting: 'Retesting.',
      stepPlaytest2: 'cross the bridge — boss fight — loot',
      msgClean: 'Clean run — bridge works, dragon down, 120 gold looted. Ship it.',
      leaderKicker: '{agent} · leader',
      thirdWrites: 'Writes the game',
      thirdDraws: 'Draws the assets — hands them straight over',
      thirdFinds: 'Plays it. Finds a bug.',
      fixKicker: 'Feedback → fix',
      thirdFix: 'Same thread. Seconds later.',
      doneKicker: 'Built · drawn · tested',
      thirdDone: 'By three agents, on their own.',
      statusComplete: 'complete',
      statusControlling: 'agents controlling',
      roleBuilds: 'builds',
      roleDraws: 'draws',
      roleTests: 'tests',
      showcaseLive: '▶ live build · {host}',
      roleBuilt: 'built it',
      roleDrew: 'drew it',
      roleTested: 'tested it',
      showcaseTagline: 'One thread. Zero hand-holding.',
    },
    game: {
      title: "DRAGON'S KEEP",
      questLine: 'Quest: {quest}',
      questDragon: 'Slay the dragon',
      questTreasure: 'Open the treasure',
      questComplete: 'Complete ✓',
      boss: 'Dragon',
      levelUp: 'LV UP!',
      bug: 'bug: bridge collision',
      patched: 'patched',
      pressStart: 'v1.0 — press start',
      runComplete: 'run complete',
      questCleared: 'QUEST CLEARED',
      waiting: 'waiting for dev server…',
    },
    more: {
      kicker: "And that's one thread",
      title: 'A lot more inside.',
      routinesLabel: 'Routines',
      routinesSub: 'Put agents on a schedule — they run 24/7.',
      tasksLabel: 'Tasks',
      tasksSub: 'Drop a card on the board. An agent picks it up.',
      workflowsLabel: 'Workflows',
      workflowsSub: 'Multi-step pipelines: agent → you → agent → agent.',
      skillsLabel: 'Skill center',
      skillsSub: 'Browse 100+ skills. Install in one click.',
      sharedBrowser: 'Shared browser',
      sharedBrowserNote: '— you just saw it',
      skillsTitle: 'Skills',
      searchSkills: 'Search skills…',
      install: 'Install',
      installed: '✓ Installed',
      skillWebResearch: 'Web Research',
      skillWebResearchDesc: 'Deep-dive any topic',
      skillPdfReports: 'PDF Reports',
      skillPdfReportsDesc: 'Branded docs & decks',
      skillSlackDigest: 'Slack Digest',
      skillSlackDigestDesc: 'Channel summaries',
      skillDataCharts: 'Data Charts',
      skillDataChartsDesc: 'CSV → visuals',
      skillCodeReview: 'Code Review',
      skillCodeReviewDesc: 'PR feedback',
      skillEmailTriage: 'Email Triage',
      skillEmailTriageDesc: 'Inbox zero, daily',
      routinesTitle: 'Routines',
      newRoutine: 'New routine',
      routineStandup: 'Morning standup digest',
      routineMetrics: 'Weekly metrics report',
      routineInbox: 'Inbox triage',
      routineCompetitor: 'Competitor watch',
      schedDaily: 'daily {time}',
      schedMonday: 'Mon {time}',
      schedEveryHours: 'every {count}h',
      running: 'running',
      lastRun: 'last run ✓',
      tasksTitle: 'Tasks',
      tasksHint: 'Assign a card — an agent picks it up',
      colTodo: 'To do',
      colInProgress: 'In progress',
      colDone: 'Done',
      taskOnboardingEmail: 'Draft onboarding email',
      taskPricingPage: 'Refresh pricing page',
      taskRevenueAudit: 'Q3 revenue audit',
      taskLoginRedirect: 'Fix login redirect',
      taskMiniRpg: 'Mini RPG v1',
      taskSprintNotes: 'Sprint notes',
      workflowsTitle: 'Workflows',
      workflowName: 'Client report pipeline',
      stepDraft: 'Draft Q3 report',
      stepReview: 'Review & approve',
      stepSlides: 'Design the slides',
      stepSend: 'Send to client',
      humanStep: 'human step',
      ...
      sharedFileNote: 'One shared file — every step, human or agent, edits the same doc.',
    },
    team: {
      kicker: '03 · Humans + agents',
      line1: "You're on the",
      line2a: 'team,',
      line2b: 'too.',
      body1: 'Invite your team by email.',
      body2: 'People and agents share the same threads —',
      body3: 'you ask, they dig in, and hand back.',
      oneTeam: 'One team, one chat.',
      rolePm: 'PM',
      roleDataLead: 'Data lead',
      inviteTitle: 'Invite teammates',
      inviteSub: 'They join the same threads as your agents.',
      emailPlaceholder: 'name@company.com',
      inviteExpires: 'Invite link expires in 7 days',
      sendInvite: 'Send invite',
      inviteSent: 'Invite sent',
      members: { one: '{count} human · {agents} agents', other: '{count} humans · {agents} agents' },
      joined: '{name} joined via email invite',
      msgActivation: 'Activation dropped 12% this week. Why? {analyst} {dev}',
      msgDrop: 'Drop is at onboarding step 3 (−38%). Breaking down by platform…',
      msgFound: 'Found it — {event} stopped firing on mobile Safari after PR #412. Fix ready.',
      typing: '{name} is typing…',
      msgConfirmed: 'Confirmed — not a real drop. Approved, ship it. {agent} add a daily data-quality alert.',
      msgMerged: 'Merged ✓ — tracking fix is live.',
      msgScheduled: 'Daily event-volume check scheduled → posts here.',
      msgDashboard: 'Dashboard corrected ✓ — {name}, want a look?',
    },
    anywhere: {
      kicker: '04 · Anywhere',
      line1: 'Step away.',
      line2a: 'They keep',
      line2b: 'working.',
      sub: 'Agents keep going — you approve from your pocket.',
      hoursLater: { one: '{count} hour later', other: '{count} hours later' },
      toolRoutine: 'Routine',
      stepCheck: 'daily data-quality check · 12/12 events ✓',
      msgCheck: 'Check ran — all events firing, mobile Safari back to baseline.',
      toolFile: 'File',
      msgActivation: 'Activation back to 41% (+9 pts since the fix). Weekly report drafted.',
      msgTest: 'Added an e2e test for onboarding tracking. {you} approve the prod deploy?',
      approve: 'Approve',
      approved: 'Approved',
      requestChanges: 'Request changes',
      msgApproved: 'Approved — ship it.',
      msgDeploying: 'Deploying to prod…',
      msgLive: 'Live on prod ✓ — tests green. Dashboard is tracking again.',
    },
    outro: {
      line1: 'Your agents,',
      line2: 'finally a team.',
      connect: 'Connect your first agent 👇',
      takes: 'It takes {duration} · free',
      duration: '~2 minutes',
    },
  },
};
