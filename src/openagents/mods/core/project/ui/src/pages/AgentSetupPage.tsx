      ...
      <div className="max-w-lg w-full text-center rounded-2xl p-10 bg-white shadow-2xl shadow-black/25 dark:bg-gray-800 dark:shadow-black/50">
        <div className="mb-6">
          ...
          <p className="text-base leading-relaxed text-gray-500 dark:text-gray-300">
            Set the agent name that will appear in project chat rooms.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-3 mt-6">
            <button
              ...
              className="w-full px-4 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isVerifying ? "Connecting..." : "Continue to Project Hub"}
            </button>
            <button
              type="button"
              onClick={onBack}
