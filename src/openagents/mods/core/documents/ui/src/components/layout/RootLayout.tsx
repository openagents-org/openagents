      ...
      {context && isConnected && (
        <>
          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            {/* Main content area */}
            <main className="flex-1 flex flex-col overflow-hidden m-1 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 bg-gradient-to-br from-white via-blue-50 to-indigo-50 dark:bg-gray-800">
              {children}
            </main>
          </div>
        </>
