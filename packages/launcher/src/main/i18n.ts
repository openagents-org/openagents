...
const STRINGS: Record<MainLanguage, Record<string, string>> = {
  en: {
    ...
    trayTooltipUpdates: "OpenAgents · {{count}} updates available",
    trayTooltipUpdatesOne: "OpenAgents · 1 update available",
  ...
  zh: {
    ...
    startupFailedBody:
      "{{message}}\n\n完整日志：\n{{log}}\n\n如果反复出现，请把日志发给我们。",
    trayTooltip: "OpenAgents",
    trayTooltipUpdates: "OpenAgents · {{count}} 个更新可用",
    trayTooltipUpdatesOne: "OpenAgents · 1 个更新可用",
