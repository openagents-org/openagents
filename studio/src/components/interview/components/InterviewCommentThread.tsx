...
import { InterviewComment } from '@/stores/interviewStore';
import { useInterviewStore } from '@/stores/interviewStore';

interface InterviewCommentThreadProps {
  comments: InterviewComment[];
  topicId: string;
  maxDepth?: number;
}

const InterviewCommentThread: React.FC<InterviewCommentThreadProps> = ({
  comments,
  topicId,
  maxDepth = 5
}) => {
...
interface InterviewCommentItemProps {
  comment: InterviewComment;
  topicId: string;
  maxDepth: number;
}

const InterviewCommentItem: React.FC<InterviewCommentItemProps> = React.memo(({
  comment,
  topicId,
  maxDepth
}) => {
  ...
  const { addComment } = useInterviewStore();
...
InterviewCommentItem.displayName = 'InterviewCommentItem';

export default InterviewCommentThread;
